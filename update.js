module.exports = {
  run: [
    ...
    // 5. Reinstall frontend dependencies (clean + hoisted layout for Next.js compat)
    {
      method: "shell.run",
      params: {
        path: "app/frontend",
        ...
        message: "{{platform === 'win32' ? 'if exist node_modules rmdir /s /q node_modules' : 'rm -rf node_modules'}}",
      },
    },
    {
      method: "shell.run",
